 ...
 *
 */
void ingresarStringValidaURL(char mensajeAMostrar[], char mensajeError[], char mensajeErrorExced[], char input[], int largoMax);
 ...
 * \return 1 si el texto contiene solo letras
 */
int ingresarStringURL(char mensaje[],char input[]);
 ...
 * \param Mensaje1[] char Si el cod. es 0, se muestra mensaje1.
 * \param Mensaje2[] char Si el cod. es 1, se muestra mensaje2.
 * \param Mensaje3[] char Si el cod. es 1, se muestra mensaje3.
 * \return void
 *
 */
